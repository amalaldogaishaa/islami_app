...
class QuranService {
  ...
  static List<String> englishSurahsNames = [
    "Al-Fatiha",
    "Al-Baqarah",
    "Aal-E-Imran",
    "An-Nisa'",
  ...
  static Sura getSuraFromIndex(int index) => Sura(
    englishName: englishSurahsNames[index],
    arabicName: arabicSurasNames[index],
  ...
  static void searchSura(String query) {
    suras.clear();
    for (int i = 0; i < 114; i++) {
      if (arabicSurasNames[i].contains(query) ||
          englishSurahsNames[i].toLowerCase().contains(query.toLowerCase())) {
  ...
  static Future<String> loadSuraFile(int suraNum) =>
      rootBundle.loadString('assets/textdata/$suraNum.txt');
